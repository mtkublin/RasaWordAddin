...
namespace WordAddIn1
{
    public partial class Ribbon1
    {
        ...
        {
            public static string NameInputDialog(string text, string caption)
            {
            ...
            public static string ModelNameTakenDialog(string TakenModelName)
            {
                Form prompt = new Form()
                {
                    Width = 235,
                ...
                NOTconfirmation.Click += (sender, e) => { TakenModelName = Prompt.NameInputDialog("Model name:", "TRAIN!"); prompt.Close(); };
                prompt.Controls.Add(confirmation);
            ...
            public static string ProjectNameTakenDialog(string TakenModelName)
            {
                Form prompt = new Form()
                {
                    Width = 235,
                ...
                NOTconfirmation.Click += (sender, e) => { TakenModelName = Prompt.NameInputDialog("New Project name:", "CREATE!"); prompt.Close(); };
                prompt.Controls.Add(NOTconfirmation);
                prompt.Controls.Add(textLabel);
            ...
            public static string TextMessageOkDialog(string SomeString = "")
            {
                Form prompt = new Form()
                {
                    Width = 235,
